...
Files: macbook.glb [629.72KB] > D:\documentos\Documents\Dev\aprendiendo-react\projects\landing\macbook-gsap-app\public\models\macbook-transformed.glb [627.9KB] (0%)
...
export default function MacbookModel(props) {
  const { textureVideo, color } = useMacbookStore()
  const { nodes, materials, scene } = useGLTF('/models/macbook-transformed.glb')

  const screen = useVideoTexture(textureVideo)
