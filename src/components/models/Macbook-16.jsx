...
Files: macbook-16.glb [639.28KB] > D:\documentos\Documents\Dev\aprendiendo-react\projects\landing\macbook-gsap-app\public\models\macbook-16-transformed.glb [629.72KB] (1%)
  ...
  const texture = useTexture('/screen.jpg')
    ...
    useEffect(() => {
      scene.traverse((child) => {
        if (child.isMesh) {
          // Change the color only if the part isn't noChangePart
